<template>
	<div v-title data-title="发起预约" v-loading="loading">
		...
		<div class="initiating">
			...
			<div class="initiating-xing" v-if="LinkaAppointsDetailData.appoint_appraise">
				<p><span>行家专业度</span>
					<yd-rate slot="left" v-model="LinkaAppointsDetailData.appoint_appraise.star" color="#D6D6D6" active-color="#FFD800" size="18px" :readonly="true"></yd-rate>
				</p>
				<p><span>内容满意度</span>
					<yd-rate slot="left" v-model="LinkaAppointsDetailData.appoint_appraise.degree" color="#D6D6D6" active-color="#FFD800" size="18px" :readonly="true"></yd-rate>
				</p>
			</div>
			<div class="initiating-a" v-if="LinkaAppointsDetailData.appoint_appraise">
				<p class="initiating-a-title">内容回顾</p>
				<div class="initiating-a-content iblack">
					<p>{{LinkaAppointsDetailData.appoint_appraise.content}}</p>
				</div>
			</div>
