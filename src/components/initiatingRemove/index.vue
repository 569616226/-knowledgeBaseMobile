	...
	<div v-title data-title="发起预约" v-loading="loading">
		...
		<div class="initiating">
			...
			<div class="initiating-wait">
				...
				<p style="font-size: .36rem;"><b>{{LinkaAppointsDetailData.canceler}}已取消预约</b></p>
				<p style="font-size: .28rem;">取消原因：{{LinkaAppointsDetailData.cancel_res}}</p>
			</div>
